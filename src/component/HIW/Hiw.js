    ...
    <Container>
      ...
      <Item color="white">
        ...
        <div>
          ...
          <Subtitle>
            Streamline communication with your renters for payments, maintenance
            requests and more.
          </Subtitle>
        </div>
      </Item>
      ...
      <Item Height={"432"}>
        <div>
          <Heading Height={"96"}>
            Be a Confident and Professional Landlord
          </Heading>
          <Subtitle>
            Learn how to be a better landlord through an extensive set of tools,
