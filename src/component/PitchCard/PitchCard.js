    ...
    <Container>
      <Frame>
        <Card>
          ...
          <Subtitle>
            ...
            renters. Just create 1 listing and we’ll post it across the web to
            all major rental networks like Zillow and Trulia.
          </Subtitle>
        ...
        <Card>
          ...
          <Subtitle>
            ...
            tenant screening, use Avail to request and review tenant
            applications online. It’s never been easier
        ...
        <Card>
          ...
          <Subtitle>
            Avoid the frustrations by using our streamlined software. Simply
            enter your tenant’s email, wait for them to authorize the report,
            and soon you can review their full credit report online.
          </Subtitle>
      ...
      <Frame id="midile">
        <Card>
          ...
          <Subtitle>
            Renting should be easy for your tenants too. With Avail, your
            tenants get access to a resident portal for 24-hour access to pay
            rent, submit maintenance requests and more.
          </Subtitle>
